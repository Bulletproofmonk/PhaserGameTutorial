...
preload: function() {
	...
	game.load.audio('blaster','http://examples.phaser.io/assets/audio/SoundEffects/blaster.mp3');
	
	game.load.audio('explosion','http://examples.phaser.io/assets/audio/SoundEffects/explosion.mp3');
	
	
	game.load.audio('song','http://examples.phaser.io/assets/audio/bodenstaendig_2000_in_rock_4bit.mp3');
},
